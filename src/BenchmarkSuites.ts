...
export const CORTEXSUITE_VISION: BenchmarkSuite = {
    ...
    apps: {
        "vision-disparity": {
            ...
            amalgamate: true,
            extraFlags: ["-Dfullhd"],
            extraFiles: ["Makefile", "data/fullhd", "run_all.sh"]
        },
        "vision-localization": {
            standard: "c11",
            ...
            amalgamate: true,
            extraFlags: ["-Dvga"],
            extraFiles: ["Makefile", "data/vga", "run_all.sh"]
        },
        "vision-mser": {
            standard: "c11",
            topFunction: "mser",
        ...
        "vision-multi-ncut": {
            ...
            amalgamate: true,
            extraFlags: ["-Dqcif"],
            extraFiles: ["Makefile", "data/qcif", "run_all.sh"]
        },
        "vision-pca": {
            standard: "c11",
            topFunction: "pca",
            canonicalName: "pca",
            amalgamate: true,
            extraFiles: ["Makefile", "data", "run_all.sh"]
        },
        "vision-sift": {
            standard: "c11",
        ...
        "vision-svm": {
            ...
            amalgamate: true,
            extraFlags: ["-Dcif"],
            extraFiles: ["Makefile", "data/cif", "run_all.sh"]
        },
