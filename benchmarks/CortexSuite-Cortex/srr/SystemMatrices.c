...
void CalcShiftMat(double x, double y)
{
    ...
    for (i = 0; i < l; i++)
    {
        for (j = 0; j < l; j++)
        {
            ...
            if (pij < -x_dim * l * l)
            {
                S00[k][pij + x_dim * l * l + l * l] = w1;
            } // lower lower
            else if (pij < -x_dim * l * l + l * l)
            {
                if (y < 0)
                {
                    S01[k][pij + x_dim * l * l] = w1;
                }
                else
                {
                    S00[k][pij + x_dim * l * l] = w1;
                } // lower upper or lower lower
            }
            else if (pij < -x_dim * l * l + 2 * l * l)
            {
                S01[k][pij + x_dim * l * l - l * l] = w1;
            } // lower upper
            else if (pij < 0)
            {
                if (x < 0)
            ...
            else if (pij < 2 * l * l)
            {
                ...
                {
                    S11[k][pij - l * l] = w1;
                } // lower upper or upper upper
                else
                {
                    S01[k][pij - l * l] = w1;
                }
            }
            else if (pij < x_dim * l * l)
            {
                S10[k][pij - x_dim * l * l + l * l] = w1;
            } // upper lower
            else if (pij < (x_dim * l * l + l * l))
            {
                if (y < 0)
                {
                    S11[k][pij - x_dim * l * l] = w1;
                }
                else
                {
                    S10[k][pij - x_dim * l * l] = w1;
                } // upper lower or upper upper
            }
            else if (pij < (x_dim * l * l + 2 * l * l))
            {
                S11[k][pij - (x_dim * l * l + l * l)] = w1;
            } // upper upper
            // Inversed ...
            ...
            if (pij < -x_dim * l * l)
            {
                S00[k][pij + x_dim * l * l + l * l] = w2;
            } // lower lower
            else if (pij < -x_dim * l * l + l * l)
            {
                if (y < 0)
                {
                    S01[k][pij + x_dim * l * l] = w2;
                }
                else
                {
                    S00[k][pij + x_dim * l * l] = w2;
                } // lower upper or lower lower
            }
            else if (pij < -x_dim * l * l + 2 * l * l)
            {
                S01[k][pij + x_dim * l * l - l * l] = w2;
            } // lower upper
            else if (pij < 0)
            {
                if (x < 0)
            ...
            {
                S10[k][pij - x_dim * l * l + l * l] = w2;
            } // upper lower
            else if (pij < (x_dim * l * l + l * l))
            {
                if (y < 0)
                {
                    S11[k][pij - x_dim * l * l] = w2;
                }
                else
                {
                    S10[k][pij - x_dim * l * l] = w2;
                } // upper lower or upper upper
            }
            else if (pij < (x_dim * l * l + 2 * l * l))
            {
                S11[k][pij - (x_dim * l * l + l * l)] = w2;
            } // upper upper
            ...
            if (pij < -x_dim * l * l)
            {
                S00[k][pij + x_dim * l * l + l * l] = w3;
            } // lower lower
            else if (pij < -x_dim * l * l + l * l)
            {
                if (y < 0)
                {
                    S01[k][pij + x_dim * l * l] = w3;
                }
                else
                {
                    S00[k][pij + x_dim * l * l] = w3;
                } // lower upper or lower lower
            }
            else if (pij < -x_dim * l * l + 2 * l * l)
            {
                S01[k][pij + x_dim * l * l - l * l] = w3;
            } // lower upper
            else if (pij < 0)
            {
                if (x < 0)
            ...
            {
                S10[k][pij - x_dim * l * l + l * l] = w3;
            } // upper lower
            else if (pij < (x_dim * l * l + l * l))
            {
                if (y < 0)
                {
                    S11[k][pij - x_dim * l * l] = w3;
                }
                else
                {
                    S10[k][pij - x_dim * l * l] = w3;
                } // upper lower or upper upper
            }
            else if (pij < (x_dim * l * l + 2 * l * l))
            {
                S11[k][pij - (x_dim * l * l + l * l)] = w3;
            } // upper upper
            ...
            if (pij < -x_dim * l * l)
            {
                S00[k][pij + x_dim * l * l + l * l] = w4;
            } // lower lower
            else if (pij < -x_dim * l * l + l * l)
            {
                if (y < 0)
                {
                    S01[k][pij + x_dim * l * l] = w4;
                }
                else
                {
                    S00[k][pij + x_dim * l * l] = w4;
                } // lower upper or lower lower
            }
            else if (pij < -x_dim * l * l + 2 * l * l)
            {
                S01[k][pij + x_dim * l * l - l * l] = w4;
            } // lower upper
            else if (pij < 0)
            {
                if (x < 0)
            ...
            {
                S10[k][pij - x_dim * l * l + l * l] = w4;
            } // upper lower
            else if (pij < (x_dim * l * l + l * l))
            {
                if (y < 0)
                {
                    S11[k][pij - x_dim * l * l] = w4;
                }
                else
                {
                    S10[k][pij - x_dim * l * l] = w4;
                } // upper lower or upper upper
            }
            else if (pij < (x_dim * l * l + 2 * l * l))
            {
                S11[k][pij - (x_dim * l * l + l * l)] = w4;
            } // upper upper
