...
#else
int
    yyparse(yyscanner, jsgf) void *yyscanner;
jsgf_t *jsgf;
#endif
#endif
{
...
#line 92 "jsgf_parser.y"
    {
        jsgf->version = (yyvsp[(2) - (4)].name);
        jsgf->charset = (yyvsp[(3) - (4)].name);
    }
    break;
...
#line 93 "jsgf_parser.y"
    {
        jsgf->version = (yyvsp[(2) - (5)].name);
        jsgf->charset = (yyvsp[(3) - (5)].name);
...
#line 133 "jsgf_parser.y"
    {
        ...
        (yyval.atom)->weight = (yyvsp[(1) - (2)].weight);
    }
    break;
